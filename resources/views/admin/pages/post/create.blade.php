...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="/post/store" enctype="multipart/form-data" ng-controller="myCtrl">
                        ...
                        <div class="col-12">
                            <div class="p-20">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="post_headline"  ng-model="post_headline" ng-change="titleChange()"required>
                                ...
                                <div class="form-group row">
                                    <input type="text" class="form-control" name="post_slug" ng-model="post_slug">
                            ...
                            <div class="p-20">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="containercheckbox form-group  ">
                                        ...
                                        @foreach($categories as $category)
                                            <input class="ml-2" type="checkbox" name="category_id[]" value="{{$category->category_id}}" /> {{$category->category_bn}} <br />
                                        @endforeach
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label>Featured Image(900*500px)</label>
                                        <img id="blah" src="#" height="100px" alt="your image" />
